        ...
        <li class="collapse navbar-collapse" id="app-navbar-collapse">
            ...
            <ul class="nav navbar-nav">
                ...
                <ul class="dropdown-menu" role="menu">
                    <li><a href="{{url('resto')}}">Data Resto</a>
                ...
                @if (Auth::user() && Auth::user()->hasRole('user'))
                    <li><a href="{{url('about')}}">Dashboard</a></li>
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button">
                ...
                @else
                    ...
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">
                            @if (Auth::user() && Auth::user()->hasRole('user'))
                            {{ Auth::user()->restodata->resto_name }}<span class="caret"></span></a>

                            @endif
                        <ul class="dropdown-menu" role="menu">
                            <li><a href="{{ url('/') }}"><i class="fa fa-btn fa-sign-out"></i>Edit Profil Resto</a></li>
                        </ul>
